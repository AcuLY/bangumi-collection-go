...
`go.mod` SHALL declare Go `1.26.0`. Runtime dependencies SHALL be exactly direct `golang.org/x/sync v0.22.0` and `golang.org/x/time v0.15.0` plus only dependencies mechanically required by those modules. `x/sync/errgroup` SHALL own bounded structured cancellation; `x/time/rate` SHALL own the concurrency-safe token bucket. No runtime dependency type SHALL leak into the public API.
...
- **WHEN** Go 1.26.x runs `go mod tidy -diff` and module enumeration
- **THEN** tidiness SHALL have no diff
...
- **Owner**: delegated External collection client apply subagent; main agent reviews/amends OpenSpec and performs read-only acceptance.
- **Writable/Owned paths**: `openspec/changes/harden-bangumi-collection-go-v0-1-0/.openspec.yaml`; `openspec/changes/harden-bangumi-collection-go-v0-1-0/proposal.md`; `openspec/changes/harden-bangumi-collection-go-v0-1-0/design.md`; `openspec/changes/harden-bangumi-collection-go-v0-1-0/specs/collection-client-v0-1-0/spec.md`; `openspec/changes/harden-bangumi-collection-go-v0-1-0/tasks.md`; apply paths `README.md`, `client.go`, `collection.go`, `errors.go`, `limiter.go`, `options.go`, `request.go`, `retry.go`, `types.go`, `example/example.go`, `go.mod`, `go.sum`, `client_test.go`, `collection_test.go`, `errors_test.go`, `limiter_test.go`, `options_test.go`, `request_test.go`, `retry_test.go`, `types_test.go`, `.github/workflows/ci.yml`; final paths `openspec/changes/archive/2026-07-24-harden-bangumi-collection-go-v0-1-0/.openspec.yaml`, `openspec/changes/archive/2026-07-24-harden-bangumi-collection-go-v0-1-0/proposal.md`, `openspec/changes/archive/2026-07-24-harden-bangumi-collection-go-v0-1-0/design.md`, `openspec/changes/archive/2026-07-24-harden-bangumi-collection-go-v0-1-0/specs/collection-client-v0-1-0/spec.md`, `openspec/changes/archive/2026-07-24-harden-bangumi-collection-go-v0-1-0/tasks.md`, `openspec/specs/collection-client-v0-1-0/spec.md`.
- **Read-only protected inputs**: untracked `CLAUDE.md` hash `c69937414d643411e03f3d7982e4bf58e8ceb02802cf1338dada4ea6a630407d`; untracked `note` hash `7b2376f605f5d9d9f677eaf1165a2ff911cec9092b6b2763b966a3d6f93e2e74`; ignored `.claude/settings.local.json` hash `c67845ef6924b080344bc0010931336106d9df3a700f67f10a22763d07517e3e`; `LICENSE`; `.codex/skills/openspec-apply-change/SKILL.md`; `.codex/skills/openspec-archive-change/SKILL.md`; `.codex/skills/openspec-explore/SKILL.md`; `.codex/skills/openspec-propose/SKILL.md`; `.codex/skills/openspec-sync-specs/SKILL.md`; `.codex/skills/openspec-update-change/SKILL.md`; `openspec/config.yaml`; `openspec/changes/archive/2026-07-24-bootstrap-bangumi-collection-go-openspec/.openspec.yaml`; `openspec/changes/archive/2026-07-24-bootstrap-bangumi-collection-go-openspec/proposal.md`; `openspec/changes/archive/2026-07-24-bootstrap-bangumi-collection-go-openspec/design.md`; `openspec/changes/archive/2026-07-24-bootstrap-bangumi-collection-go-openspec/specs/external-openspec-bootstrap/spec.md`; `openspec/changes/archive/2026-07-24-bootstrap-bangumi-collection-go-openspec/tasks.md`; `openspec/specs/external-openspec-bootstrap/spec.md`; `/Users/luca/dev/BangumiStaffStats/tmp-formal-development/formal-development-master-plan.md`; `/Users/luca/dev/BangumiStaffStats/tmp-formal-development/backend-development-implementation-guide.md`; initial `59eba79b3e3621ce72b756a88b38aee970c00fcf`; baseline `8173f44911360150a5a5a7c6418021d1014fe85b`.
- **Consumes**: `bootstrap-bangumi-collection-go-openspec`, `external-openspec-bootstrap`, ten baseline product files, master-plan external lane, backend guide 6.2–6.3.
- **Produces**: exact five-file planning checkpoint, `collection-client-v0-1-0`, 21 product/test/CI paths, five archived change files, root spec, exact local implementation commit.
- **Dependencies**: `bootstrap-bangumi-collection-go-openspec` only; satisfied at `59eba79b3e3621ce72b756a88b38aee970c00fcf`.
- **Deliverables**: complete DTO, automatic pagination, shared limits, retry, typed sanitized errors, deterministic output, tests/race/CI, compatibility docs, archive/root spec, local commit.
- **Acceptance**:
  ...
  Planning checkpoint acceptance SHALL require exactly five staged active-change paths, sorted path seal `a7da0916df9b59cdaff4d5a3b57d8b0231c8bad51921aedb308ee2d10262fe1f`, exact subject, sole bootstrap parent, and main-agent read-only acceptance. Apply adds the exact Go 1.26 `gofmt`/module/version/vet/test/race commands from tasks. Finalization SHALL require a `--no-renames` 32-path staged parent delta with seal `740610fc014608d9294383d731e3a9df51b3521c25823824c6ef89dc582349b2`, a 27-path cumulative bootstrap inventory with seal `b8ef7390c49b73f13061c3ca50f66a0ef260cf947c539d507ab1797de59c48c1`, exact parent/subject/root-Purpose/requirements equality, unchanged protection seals/full status, and both main-agent implementation/finalization acceptance gates.
- **Non-goals**: credentials/private/write API; main-repository behavior; generic SDK; public-network load tests; fetch/push/PR/tag/release/publication/deployment.
- **Operations deferred**: remote Git/GitHub, tag/release/publication, consumer admission, production tuning/monitoring/rollout/deployment.
- **Stop/rollback conditions**: stop and preserve evidence on any governance/path/hash/status/index/toolchain/dependency/format/test/race/strict mismatch; do not clean/reset/stash/delete/overwrite/stage/commit. Reversal requires a new reviewed change.
- **Mutable refs**: after spec approval, only `refs/heads/codex/v0.1.0-hardening` may advance once from bootstrap to the exact planning commit. It then remains fixed through apply and both candidate reviews, after which it may advance once more to the accepted local implementation commit. Main, origin/main, tags, remote refs, and remote state remain immutable.
